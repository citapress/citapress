      ...
      <div className="flex about-content">
        ...
        {intl.locale === 'en' ? (
          <>
            ...
            <p><span className="bluu">How:</span> <span className="blue">cita</span> is a collaborative labor of love between designers and writers that relies on public-domain writings and open-source texts, fonts, code, and images. All the content of <span className="blue">cita</span> is either public-domain, or is licensed under <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/">Creative Commons License CC-NC-SA 4.0</a>, meaning it’s free forever, and sharable for non-commercial purposes so long as you can share if you say who created it. We also publish a free monthly newsletter on feminist literary and design history: <a href="https://citapress.substack.com">Cita Press Bulletin</a>.</p>
